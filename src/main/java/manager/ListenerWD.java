...
public class ListenerWD implements WebDriverListener {
    ...
    public void onError(Object target, Method method, Object[] args, InvocationTargetException e) {
       ...
       // System.out.println("Help!");
        logger.info("'Tests ends with error'");
        logger.info("============================");
       ...
       // logger.info("InvocationTargetException getMessage() " + e.getMessage());----null
        ...
        logger.info("============================");
       // logger.info("InvocationTargetException getCause() " + e.getCause());//тоже что и в getTargetException
        logger.info("============================");
    ...
    public void beforeFindElement(WebDriver driver, By locator) {
       ...
       // logger.info("Before find element --> " + driver.);
    }
